  ...
  actions: {
    ...
    async refresh(): Promise<void> {
      ...
      try {
        ...
        // REVIEW (DEV-104): um `logout()` (ou uma nova autenticação) pode
        // ter acontecido enquanto este refresh estava em voo — descarta o
        // resultado em vez de sobrescrever o estado mais recente.
