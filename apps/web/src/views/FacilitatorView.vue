...
// O store Pinia sobrevive a navegações dentro da SPA — remontar esta view
// já autenticada (ex.: voltar de outra rota) não passa por `handleLogin`.
// Sem isto, o painel ficava parado (sem refresh nem polling) até um
// logout/login manual, contradizendo o "tempo real".
onMounted(() => {
  ...
  <div class="facilitator-view">
    ...
    >
      ...
      <p class="facilitator-view__note">
        Cenários de simulação são restritos ao ambiente padrão e não se aplicam
        a grupos individuais — este painel não mostra essa métrica por grupo.
      </p>
    </AppCard>
  </div>
</template>
